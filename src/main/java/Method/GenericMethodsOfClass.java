...
public class GenericMethodsOfClass {
	...
	/**@method clickByJavaScript
	 * @discription It is used to click by javascript
	 * @param locatorValue
	 * @param locatorType
	 * @param elementName
	 */
	public void clickByJavaScript(String locatorValue, String locatorType, String elementName) {
		try {
			...
			if (st == true) {
				...
				extTest.log(Status.FAIL, elementName + " is not click");
			}
		} catch (Exception e) {
	 ...
	 * @param sendValue
	 */
	public void sendValueByJavaScript(String locatorValue,String locatorType,String element,String sendValue) {
		try {
		WebElement	we= getWebElement(locatorValue, locatorType, element);
		boolean st=checkElement(locatorValue, locatorType, element);
		if(st==true) {
			JavascriptExecutor js =(JavascriptExecutor)driver;
			js.executeScript("arguments[0].value'sendValue'", we);
			extTest.log(Status.PASS, element + " sendValue is successfully");
		}else {
			extTest.log(Status.PASS, element + " sendValue is not successfully");
		}
...
//			String innerText = "";
	 ...
	 * @throws IOException
	 */
	public void validateHeight(String locatorValue, String locatorType, int i, String elementName) throws IOException {
		try {
